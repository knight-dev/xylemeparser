                ...
                for (var x = count - 1; x >= 0; x--)
                {
                    ...
                    if (Element is Paragraph)
                    {
                        ...
                        if (XUtil.isTopic(Paragraph))
                        {
                            ...
                            var Topic = GetTopic(x + paragraphs.Count - 1, x, Elements, content);
                            SubTopics.Clear();
                            paragraphs.Clear();
                        ...
                        if (XUtil.isLesson(Paragraph))
                        {
                            ...
                            // x + 1 is important to ignore heading in count 
                            // count should be 1 less since the array starts at 0
                            var Lesson = GetLesson(x + paragraphs.Count - 1, x, Elements, content + challenge);
                            Topics.Clear();
                            paragraphs.Clear();
